...
<form action="../Controllers/controladorCoordinador.php" method="post"  >
    ...
    <H1 class="container text-2xl font-black text-white  text-center">COORDINADOR</H1>
    <br>
...
<?php
        ...
        while($data=$datos -> fetch(PDO::FETCH_ASSOC)){
            ...
            print('
                ...
                <td>'.$data["telefono"].'</td>
                <td>'.$data["programa"].'</td>
                <td class="hidden">'. $data["idCoordinador"]. ' </td>
                    
                    <td>
                        <div class="flex items-center justify-center gap-x-2">
                        <a href="../Controllers/controladorCoordinador.php?id='.$data["idCoordinador"].'&value=actualiza">
                        <button type="submit" name="btnactualizarCoordinador" id="btnactualizarCoordinador" value="ACTUALIZAR" class=" flex items-center text-gray-700  bg-sky-500 p-2 rounded-lg hover:bg-sky-600 font-bold ">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                    Update
                        </button>
                        </a>
        
                        <a href="../Controllers/controladorCoordinador.php?id='. $data["idCoordinador"]. ' &value=Borra"> 
                        <button type="button" name="btnBorrarCoordinador" id="btnBorrarCoordinador" value="BORRAR" class="text-gray-700 flex items-center bg-red-500 p-2 rounded-lg hover:bg-red-600 font-bold">
    ...
    ?>
            ...
            <div class=" container flex justify-start items-center gap-2 mb-4">
                ...
                <form action="../Controllers/controladorCoordinador.php" method="REQUEST">
                <br>
                <button type="submit" value="CREAR" name="btnCoordinador" id="btnCoordinador" value="Crear" class="flex font-bold text-sm items-center bg-gray-50 p-2 rounded-lg hover:bg-gray-200">
